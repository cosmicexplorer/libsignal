...
impl PublicKey {
    ...
    pub fn serialize(&self) -> [u8; 1 + curve25519::PUBLIC_KEY_LENGTH] {
        ...
        *key_type = key_value;
        key.copy_from_slice(self.key_data());
        result
    }
    ...
    pub fn verify_signature(
        ...
        curve25519::KeyPair::verify_signature(self.key_data(), message, signature)
    }

    /// Return the bytes in memory associated with this public key.
    fn key_data(&self) -> &[u8; curve25519::PUBLIC_KEY_LENGTH] {
        match self.key {
...
impl Ord for PublicKey {
    fn cmp(&self, other: &Self) -> Ordering {
        ...
        constant_time_cmp(self.key_data(), other.key_data())
    }
}
...
impl KeyPair {
    ...
    /// assert!(KeyPair::verify_signature(kp.public_key.public_key_bytes(), b"hello", &signature));
    /// # Ok(())
    /// # }
    ///```
    pub fn verify_signature(
        ...
        curve25519::KeyPair::verify_signature(their_public_key, message, signature)
    }
}
