...
public final class Native {
  ...
  */
  ...
  public static native byte[] IdentityKeyPair_Serialize(long privateKey, long publicKey);
  ...
  public static native long NumericFingerprintGenerator_New(int iterations, int version, byte[] localIdentifier, long localKey, byte[] remoteIdentifier, long remoteKey);
